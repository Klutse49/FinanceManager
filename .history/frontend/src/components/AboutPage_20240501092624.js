    ...
    return (
        <div style={styles.container}>
            ...
            <ul style={styles.list}>
                ...
                <li style={styles.listItem}><strong style={styles.strong}>JWT</strong> - Used for user authentication</li>
                <li style={styles.listItem}><strong style={styles.strong}>Axios</strong> - Used for making HTTP requests</li>
